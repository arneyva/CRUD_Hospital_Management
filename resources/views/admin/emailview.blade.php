                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('sendemail',$data->id) }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                {{-- required="" => kalo tidak diisi akan ada peringatan(tidak eror) --}}
                                                    name="greeting" placeholder="Write Doctor Name ....." required="">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="exampleInputUsername2"
                                                class="col-sm-3 col-form-label">Body</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" style="color: rgb(0, 0, 0)"
                                                    name="body" placeholder="Write Doctor Number ....." required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Action Text</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" style="color: white"
                                                    name="actiontext" placeholder="Write Room Number ....." required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" style="color: white"
                                                    name="actionurl" placeholder="Write Room Number ....." required="">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="exampleInputUsername2"
                                                class="col-sm-3 col-form-label">End Part</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" style="color: rgb(0, 0, 0)"
                                                    name="endpart" placeholder="Write Doctor Number ....." required="">
                                            </div>
                                        </div>
